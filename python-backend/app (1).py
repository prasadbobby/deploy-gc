...
class RouterAgent(Agent):
    ...
    def process(self, task: Dict) -> Dict:
        ...
        try:
            ...
            # Enhanced router prompt with more explicit instructions
            router_prompt = f"""You are an AI medical query router. Your task is to categorize the following medical query into EXACTLY ONE of these specific categories:

    1. "clinical" - For general medical treatment, case analysis, patient care scenarios
    2. "symptom" - For specific symptom descriptions, diagnosis inquiries, condition analysis
    3. "drug" - For medication information, drug interactions, pharmaceutical queries
    4. "literature" - For medical research, scientific studies, academic medical information
    5. "diet" - For nutrition, dietary recommendations, food-related health queries

    Query: "{query}"

    IMPORTANT RULES:
    - Choose ONLY ONE category
    - Be precise in your category selection
    - If unsure, default to "clinical"
    - Respond with ONLY the category name in lowercase

    Analyze the query carefully and classify it into the most appropriate category."""
