...
export default function UnifiedChatInterface() {
  ...
  }, [messages, cameraActive, typingIndicator]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (message.trim()) {
      ...
      try {
        ...
        const responseContent = data.response || data.message || "I'm sorry, I couldn't process your request properly. Please try again.";
        const detectedAgent = data.agent || chatType;
        const processingTime = data.processing_time || null;
                      ...
                      <div className="flex items-center justify-between mb-1">
                        ...
                        {msg.metadata?.processingTime && (
                          <span className="text-xs text-muted-foreground ml-2">
                           Processing time:  {msg.metadata.processingTime}
                          </span>
                        )}
                      </div>
                    )}
  ...
  <div className="flex justify-start">
    ...
    >
      ...
      <div>
        {/* Remove the agent badge from here, so nothing shows during typing */}
      ...
      <div className="border-t bg-white dark:bg-gray-800 p-4 shadow-sm sticky bottom-0 left-0 right-0">
        <form onSubmit={handleSubmit} className="flex w-full space-x-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <MicButton onSpeechRecognized={handleSpeechRecognized} disabled={isLoading} />
          </div>
