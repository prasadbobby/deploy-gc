...
export default function HealthOverview() {
  ...
  const healthAnalyticsData = [
    { month: 'Jan', clinical: 15, literature: 10, symptom: 20, drug: 8 },
    { month: 'Feb', clinical: 22, literature: 13, symptom: 25, drug: 15 },
    { month: 'Mar', clinical: 28, literature: 18, symptom: 22, drug: 20 },
    { month: 'Apr', clinical: 18, literature: 22, symptom: 30, drug: 12 },
    { month: 'May', clinical: 35, literature: 20, symptom: 28, drug: 18 },
    { month: 'Jun', clinical: analyticsData.messagesByAgent.clinical || 30, 
               literature: analyticsData.messagesByAgent.literature || 25, 
               symptom: analyticsData.messagesByAgent.symptom || 22, 
               drug: analyticsData.messagesByAgent.drug || 20 }
  ];
  
  // Prepare session type data from analytics
  const sessionTypeData = [
    { name: 'Clinical', value: analyticsData.messagesByAgent.clinical || 42, fill: 'hsl(var(--chart-1))' },
    { name: 'Literature', value: analyticsData.messagesByAgent.literature || 28, fill: 'hsl(var(--chart-2))' },
    { name: 'Symptom', value: analyticsData.messagesByAgent.symptom || 33, fill: 'hsl(var(--chart-3))' },
    { name: 'Drug', value: analyticsData.messagesByAgent.drug || 27, fill: 'hsl(var(--chart-4))' }
  ];
          ...
          <TabsContent value="overview" className="space-y-4 mt-4">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{analyticsData.messagesByAgent.clinical || 0}</div>
                  <p className="text-xs text-muted-foreground">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{analyticsData.bookings || 0}</div>
                  <p className="text-xs text-muted-foreground">
                    +6.8% from last month
                  </p>
                </CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{analyticsData.imageAnalyses || 0}</div>
                  <p className="text-xs text-muted-foreground">
